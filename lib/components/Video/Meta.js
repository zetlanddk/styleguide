...
exports.default = exports.Meta = exports.profilePictureMargin = exports.profilePictureSize = void 0;
...
var _vimeo = _interopRequireDefault(require("react-icons/lib/fa/vimeo"));

var _youtubePlay = _interopRequireDefault(require("react-icons/lib/fa/youtube-play"));
...
var Meta = function Meta(_ref2) {
  var url = _ref2.url,
      ...
      userUrl = _ref2.userUrl,
      userProfileImageUrl = _ref2.userProfileImageUrl,
      date = _ref2.date;
  var Icon = ICON[platform];
  return _react.default.createElement("div", styles.root, _react.default.createElement(Link, {
    ...
    href: url
  }, _react.default.createElement(Icon, styles.icon)), _react.default.createElement("div", styles.meta, _react.default.createElement("div", styles.name, _react.default.createElement("div", styles.nameText, _react.default.createElement(Link, {
    href: userUrl
  }, userName))), _react.default.createElement("div", styles.subline, _react.default.createElement("div", styles.sublineText, _react.default.createElement(Link, {
    href: url
  }, dateFormat(date))))));
};
...
Meta.propTypes = {
  ...
  userUrl: _propTypes.default.string.isRequired,
